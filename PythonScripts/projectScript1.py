...
tempList = []  ###### create an array to strore tempreture readings 

epoch = int(time.time()) ###### return epoch value

for x in range(0, 10):  ######### this for loop reads ten tempreture values into tempList and returns the average in newTempVar
